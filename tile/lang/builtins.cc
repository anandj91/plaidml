...
std::map<std::string, std::shared_ptr<BoundFunction>> DerivDefines = {
    ...
    {"as_float4_custom4", ddef({"as_custom4_float4(DY, 32)", "0"})},
    {"as_custom4_float4", ddef({"as_float4_custom4(DY, 32)", "0"})},
    {"as_float4_float8", ddef({"as_float8_float4(DY, 64)", "0"})},
    {"as_float8_float4", ddef({"as_float4_float8(DY, 32)", "0"})},
    {"bit_and", ddef({"0", "0"})},
    {"bit_or", ddef({"0", "0"})},
    {"bit_xor", ddef({"0", "0"})},
    {"bit_left", ddef({"0", "0"})},
