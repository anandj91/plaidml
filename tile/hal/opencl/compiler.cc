...
boost::future<std::unique_ptr<hal::Library>> Compiler::Build(const context::Context& ctx,
  ...
  code << "  float f;\n";
  code << "} custom;\n";
  code << "__local custom __OVERLOADABLE__ custom_neg(custom a) {\n";
  code << "  custom c;\n";
  code << "  c.f = -a.f;\n";
  code << "  return c;\n";
  code << "}\n";
  ...
  code << "}\n";
  code << "__local int __OVERLOADABLE__ custom_cmp_ne(custom a, custom b) {\n";
  code << "  return (int)(a.f != b.f);\n";
  code << "}\n";
  ...
  code << "  return (int)(a.f < b.f);\n";
  code << "}\n";
  code << "__local custom __OVERLOADABLE__ select(custom t, custom f, int d) {\n";
  code << "  custom c;\n";
  code << "  c.f = select(t.f, f.f, d);\n";
  code << "  return c;\n";
  code << "}\n";
  code << "__local custom __OVERLOADABLE__ mad(custom a, custom b, custom d) {\n";
  code << "  custom c;\n";
  code << "  c.f = mad(a.f, b.f, d.f);\n";
  code << "  return c;\n";
  code << "}\n";
  code << "__local custom __OVERLOADABLE__ native_log(custom a) {\n";
  code << "  custom c;\n";
  code << "  c.f = native_log(a.f);\n";
  code << "  return c;\n";
  code << "}\n";
  code << "__local custom __OVERLOADABLE__ native_exp(custom a) {\n";
  code << "  custom c;\n";
  code << "  c.f = native_exp(a.f);\n";
  code << "  return c;\n";
  code << "}\n";
