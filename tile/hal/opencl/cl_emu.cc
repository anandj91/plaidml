...
class TypeEmulator : public sem::Visitor {
 public:
  explicit TypeEmulator(std::vector<DataType> types, bool cl_khr_fp16, const hal::proto::HardwareSettings& settings)
      : types_{types}, cl_khr_fp16_{cl_khr_fp16}, settings_{settings} {}
